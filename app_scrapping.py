...
import bs4
import re
from my_decorator import loger_decor as write_log
from setting_log import file_name, file_dir
...
@write_log(file_name, file_dir)
def get_links(current_url, b_url):
